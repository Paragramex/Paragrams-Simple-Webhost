...
if (!file_exists(__DIR__ . "/$user/")) {
    echo "<p style='color:red;'> Sorry, but account does not exist, please check your spelling and try again</p>";
} else {
header("Location: /$user/admin.php");
}
}
?>
<title><?php echo htmlspecialchars($configdb->forumtitle); ?> | Login</title>
...
<p class="text--center">Want an account? <a href="/">Register</a></p>
